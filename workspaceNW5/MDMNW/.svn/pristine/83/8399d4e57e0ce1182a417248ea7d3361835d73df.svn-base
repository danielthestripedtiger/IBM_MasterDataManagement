...
/*
 * IBM-MDMWB-1.0-[8a157771bffe9dd92bfee8d02c849fb8]
 */
 ...
 *
 * @see mdmnw.bobj.query.XNWPersonNameBObjExtQuery
 *
 * @generated
 */

public class XNWPersonNameExtResultSetProcessor extends TCRMPersonNameResultSetProcessor {
     ...
     * @generated
     */
    public XNWPersonNameExtResultSetProcessor() {
        super();
    }
   ...
   **/
    public Object createObject(Object eObjs) throws Exception {
        XNWPersonNameBObjExt theBObj = (XNWPersonNameBObjExt) super.createObject(eObjs);
        Queue<?> eobjQueue = (Queue<?>) eObjs;
        if( !eobjQueue.isEmpty() )
        {
        	EObjxNWPersonNameExt theEObj = (EObjxNWPersonNameExt)  eobjQueue.remove();
          theBObj.setEObjxNWPersonNameExt( theEObj );
        }
        return theBObj;
    }
