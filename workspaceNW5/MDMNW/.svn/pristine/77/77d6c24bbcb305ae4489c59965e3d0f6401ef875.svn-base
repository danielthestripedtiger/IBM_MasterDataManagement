...
-- 			db2 -vf Rollback_MDMNW_MetaData_DB2.sql
-- 			db2 -vf Rollback_MDMNW_CONSTRAINTS_DB2.sql
-- 			db2 -vf Rollback_MDMNW_TRIGGERS_DB2.sql
-- 			db2 -vf Rollback_MDMNW_SETUP_DB2.sql
