...
public class TC_VerifyProdEnvironment_Test extends AbstractMDMTest {
	
	static String xmlBaseDir = "req/";
	
	@Test
	public void test_retrievePartyByEmail() throws Exception {
        String response = sendRequestViaRest(CommonUtil.getStringFromFile(xmlBaseDir, "retrievePartyByEmail_Prod.json", this.getClass()));
        ...
        Assert.assertEquals(true, response.contains("\"ReferenceNumber\":\"adam@baldwinag.com\","));
	...
	public void test_retrieveAccount() throws Exception {
        String response = sendRequestViaRest(CommonUtil.getStringFromFile(xmlBaseDir, "retrieveAccount_Prod.json", this.getClass()));
        ...
        Assert.assertEquals(true, mangesResponse.contains("\"ReferenceNumber\":\"adam@baldwinag.com\","));
